...
anomaly_flags = load_csv("scripts/module6_weekly_spike_flags.csv")
priority_spikes = load_csv("scripts/module6_priority_ranked_spikes.csv")
...
classify_tab, reviews_tab, anomaly_tab, priority_tab, clusters_tab, servqual_tab, template_tab = st.tabs(
    [
