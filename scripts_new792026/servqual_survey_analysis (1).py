...
if __name__ == "__main__":
    ...
    scores_path = BASE_DIR / "servqual_dimension_scores.csv"
    triangulation_path = BASE_DIR / "servqual_nlp_triangulation.csv"
    scores.to_csv(scores_path, index=False)
    merged.to_csv(triangulation_path, index=False)
    print(f"\nSaved -> {scores_path}, {triangulation_path}")
